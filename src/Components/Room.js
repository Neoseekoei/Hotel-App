...
const Room = () => {
  ...
  return (
    <div style={{backgroundColor:'lightgray'}}>
      <h1 style={{textAlign:'center',color:'#A87539',fontSize:'55px',paddingTop:'70px'}}>AVALIBLE ROOMS</h1>
        <h1 style={{color:'#A87539',marginTop:'140px',textAlign:'center',marginBottom:'300px'}}>FIRST FLOOR</h1>
      <div className='First-Floor' style={{display: 'flex', flexDirection: 'row', width: '300px',marginLeft:'350px', marginTop:'-150px'}}>
        {first.map((first) => (
            <div key={first.id}>
              <img style={{ width: '300px', height: '300px',marginRight:'10rem',borderRadius: '20px' }} src={first.image} alt="first Image" />
              <h2>{first.name}</h2>
              <p >R{first.price}</p>
      ...
      <div className='Second-Floor' style={{display: 'flex', flexDirection: 'row', width: '300px',marginLeft:'350px' , marginTop:'-150px'}}>
      
      {second.map((second) => (
          <div key={second.id} >
            <img style={{ width: '300px', height: '300px',marginRight:'10rem',borderRadius: '20px' }} src={second.image} alt="second Image" />
            <h2>{second.name}</h2>
            <p>R{second.price}</p>
      ...
      <div className='Third-Floor' style={{display: 'flex', flexDirection: 'row', width: '300px',marginLeft:'350px', marginTop:'-150px'}}>
      
      {third.map((third) => (
          <div key={third.id}>
            <img style={{ width: '300px', height: '300px',marginRight:'10rem',borderRadius: '20px' }} src={third.image} alt="third Image" />
            <h2>{third.name}</h2>
            <p>R{third.price}</p>
      ...
      <div className='Four-Floor' style={{display: 'flex', flexDirection: 'row', width: '300px',marginLeft:'350px', marginTop:'-150px'}}>
        
      {fourth.map((fourth) => (
          <div key={fourth.id}>
            <img style={{ width: '300px', height: '300px',marginRight:'10rem',borderRadius: '20px' }} src={fourth.image} alt="fourth Image" />
            <h2>{fourth.name}</h2>
            <p>R{fourth.price}</p>
